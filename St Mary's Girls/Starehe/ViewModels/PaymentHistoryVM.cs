...
namespace Starehe.ViewModels
{
    ...
    public class PaymentHistoryVM : ViewModelBase
    {
        DateTime from;
        DateTime to;
        ObservableCollection<EmployeePaymentModel> items;
        public PaymentHistoryVM()
        {
            InitVars();
            CreateCommands();
        }
        protected override void InitVars()
        {
            ...
            Items = new ObservableCollection<EmployeePaymentModel>();
            IsBusy = false;
        }
        ...
        {
            Items = await DataAccess.GetEmployeePaymentsAsync(null, from, to);
        }
        ...
        public ObservableCollection<EmployeePaymentModel> Items
        {
            get { return items; }
            private set
            {
