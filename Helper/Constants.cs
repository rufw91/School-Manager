    ...
    public static class Constants
    {
        ...
        public static string DataFilePath
        {
            get
            {
                ...
                "\\Umanyi SMS\\Data\\" + Helper.Properties.Settings.Default.DBName + ".mdf";
            }
        }
        ...
        public static string DataDirectoryPath
        {
            get
            {
                return Environment.GetFolderPath(
                  Environment.SpecialFolder.CommonApplicationData) + "\\Umanyi SMS\\Data";
            }
        }
        public static string BackupDirectoryPath
        {
            ...
            {
                return Environment.GetFolderPath(
                  Environment.SpecialFolder.CommonApplicationData) + "\\Umanyi SMS\\Backup\\";
            }
        }
    }
}
