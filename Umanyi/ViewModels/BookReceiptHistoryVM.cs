...
namespace UmanyiSMS.ViewModels
{
    ...
    public class BookReceiptHistoryVM: ViewModelBase
    {
        DateTime from;
        DateTime to;
        ObservableCollection<BooksPurchaseModel> items;
        public BookReceiptHistoryVM()
        {
            InitVars();
            CreateCommands();
        }
        ...
        {
            IsBusy = true;
            Title = "BOOKS PURCHASE HISTORY";
            From = DateTime.Now.Date.AddDays(-5);
            To = DateTime.Now.Date;
            Items = new ObservableCollection<BooksPurchaseModel>();
            IsBusy = false;
        }
        ...
        {
            Items = await DataAccess.GetBookReceiptsAsync(false,null,from, to);
        }
        ...
        public ObservableCollection<BooksPurchaseModel> Items
        {
            get { return items; }
            private set
            {
