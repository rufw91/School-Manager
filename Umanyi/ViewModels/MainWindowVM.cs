...
namespace UmanyiSMS.ViewModels
{
    public class MainWindowVM : ViewModelBase    
    {
        ...
        protected override void CreateCommands()
        {
            ...
            GalleryNewItemCommand = new RelayCommand(o => Source = new NewGalleryItemVM(), o => true);
            GalleryAllItemsCommand = new RelayCommand(o => Source = new AllGalleryItemsVM(), o => true);
            GalleryRemoveItemCommand = new RelayCommand(o => { }, o => false);
            GalleryNewEventCommand = new RelayCommand(o => Source = new NewEventVM(), o => true);
            GalleryUpcomingEventsCommand = new RelayCommand(o => Source = new UpcomingEventsVM(), o => true);
            GalleryAllEventsCommand = new RelayCommand(o => Source = new AllEventsVM(), o => true);
            GalleryRemoveEventCommand = new RelayCommand(o => { }, o => false);
            PayrollPrintPayslipCommand = new RelayCommand(o => Source = new ReprintPaySlipVM(), o => true);
            PayrollPaymentHistoryCommand = new RelayCommand(o => Source = new PayslipsHistoryVM(), o => true);
            PayrollPayrollOptionsCommand = new RelayCommand(o => { }, o => false);
            PayrollRemovePaymentCommand = new RelayCommand(o => { }, o => false);
            AccountsPrepareBudgetCommand = new RelayCommand(o => Source = new PrepareBudgetVM(), o => true);
            AccountsCurrentExpenditureCommand = new RelayCommand(o => Source = new CurrentExpenditureVM(), o => true);
            AccountsSTOCSCommand = new RelayCommand(o => Source = new AccountsStatementOfCFVM(), o => true);
            AccountsBalanceSheetCommand = new RelayCommand(o => Source = new AccountsBalanceSheetVM(), o => true);
            AccountsTrialBalanceCommand = new RelayCommand(o => Source = new AccountsTrialBalanceVM(), o => true);
            AccountsCOACommand = new RelayCommand(o => Source = new ChartOfAccountsVM(), o => true);
            AccountsNewAccountCommand = new RelayCommand(o => Source = new NewItemCategoryVM(), o => true);
            AccountsRemoveAccountCommand = new RelayCommand(o => Source = new RemoveAccountVM(), o => true);
            ...
            SettingsCSSCommand = new RelayCommand(o => Source = new ModifySubjectsSetupVM(), o => true);
        ...
        #region Gallery
        public ICommand GalleryNewItemCommand
        {
            get;
            private set;
        }

        public ICommand GalleryAllItemsCommand
        {
            get;
            private set;
        }

        public ICommand GalleryRemoveItemCommand
        {
            get;
            private set;
        }

        public ICommand GalleryNewEventCommand
        {
            get;
            private set;
        }

        public ICommand GalleryUpcomingEventsCommand
        {
            get;
            private set;
        }

        public ICommand GalleryAllEventsCommand
        {
            get;
            private set;
        }

        public ICommand GalleryRemoveEventCommand
        {
            get;
            private set;
        }
        ...
        public ICommand PayrollPrintPayslipCommand
        {
            get;
            private set;
        }

        public ICommand PayrollPaymentHistoryCommand
        {
            get;
            private set;
        }

        public ICommand PayrollPayrollOptionsCommand
        {
            get;
            private set;
        }

        public ICommand PayrollRemovePaymentCommand
        {
            get;
            private set;
        }
        ...
        #region  Accounts
        public ICommand AccountsPrepareBudgetCommand
        {
            get;
            private set;
        }

        public ICommand AccountsCurrentExpenditureCommand
        {
            get;
            private set;
        }

        public ICommand AccountsSTOCSCommand
        {
            get;
            private set;
        }

        public ICommand AccountsBalanceSheetCommand
        {
            get;
            private set;
        }

        public ICommand AccountsTrialBalanceCommand
        {
            get;
            private set;
        }

        public ICommand AccountsCOACommand
        {
            get;
            private set;
        }

        public ICommand AccountsNewAccountCommand
        {
            get;
            private set;
        }

        public ICommand AccountsRemoveAccountCommand
        {
            get;
            private set;
        }
        ...
        public ICommand SettingsCSSCommand
        {
            get;
            private set;
        }
