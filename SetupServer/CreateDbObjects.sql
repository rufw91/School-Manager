...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptHeader_IsCancelled]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptHeader] DROP CONSTRAINT [DF_BookReceiptHeader_IsCancelled]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptHeader_ModifiedDate]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptHeader] DROP CONSTRAINT [DF_BookReceiptHeader_ModifiedDate]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptHeader_rowguid]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptHeader] DROP CONSTRAINT [DF_BookReceiptHeader_rowguid]
END
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[BookReceiptHeader]') AND type in (N'U'))
DROP TABLE [Sales].[BookReceiptHeader]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetB7WeightedExamTotalScore]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[GetB7WeightedExamTotalScore]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetBookPurchaseTotal]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[GetBookPurchaseTotal]
GO
...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptDetail_BookReceiptDetailID_1]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptDetail] DROP CONSTRAINT [DF_BookReceiptDetail_BookReceiptDetailID_1]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptDetail_ModifiedDate_1]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptDetail] DROP CONSTRAINT [DF_BookReceiptDetail_ModifiedDate_1]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_BookReceiptDetail_rowguid_1]') AND type = 'D')
BEGIN
ALTER TABLE [Sales].[BookReceiptDetail] DROP CONSTRAINT [DF_BookReceiptDetail_rowguid_1]
END
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[BookReceiptDetail]') AND type in (N'U'))
DROP TABLE [Sales].[BookReceiptDetail]
GO
...
BEGIN
ALTER TABLE [Institution].[StudentTranscriptDetail] DROP CONSTRAINT [DF_StudentTranscriptDetail_StudentTranscriptDetailID]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_StudentTranscriptDetail_ModifiedDate]') AND type = 'D')
BEGIN
ALTER TABLE [Institution].[StudentTranscriptDetail] DROP CONSTRAINT [DF_StudentTranscriptDetail_ModifiedDate]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_StudentTranscriptDetail_rowguid]') AND type = 'D')
BEGIN
ALTER TABLE [Institution].[StudentTranscriptDetail] DROP CONSTRAINT [DF_StudentTranscriptDetail_rowguid]
END
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Institution].[StudentTranscriptDetail]') AND type in (N'U'))
DROP TABLE [Institution].[StudentTranscriptDetail]
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_StudentTranscriptExamDetail_StudentTranscriptExamDetailID]') AND type = 'D')
BEGIN
ALTER TABLE [Institution].[StudentTranscriptExamDetail] DROP CONSTRAINT [DF_StudentTranscriptExamDetail_StudentTranscriptExamDetailID]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_StudentTranscriptExamDetail_ModifiedDate]') AND type = 'D')
BEGIN
ALTER TABLE [Institution].[StudentTranscriptExamDetail] DROP CONSTRAINT [DF_StudentTranscriptExamDetail_ModifiedDate]
END
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_StudentTranscriptExamDetail_rowguid]') AND type = 'D')
BEGIN
ALTER TABLE [Institution].[StudentTranscriptExamDetail] DROP CONSTRAINT [DF_StudentTranscriptExamDetail_rowguid]
END
GO
...
CREATE TABLE [Institution].[Subject](
	...
	[Code] [int] NOT NULL,
	[MaximumScore] [varchar](50) NOT NULL CONSTRAINT [DF_SubjectHeader_MaximumScore]  DEFAULT ((100)),
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Institution].[StudentTranscriptExamDetail]') AND type in (N'U'))
BEGIN
CREATE TABLE [Institution].[StudentTranscriptExamDetail](
	[StudentTranscriptExamDetailID] [int] NOT NULL CONSTRAINT [DF_StudentTranscriptExamDetail_StudentTranscriptExamDetailID]  DEFAULT ([dbo].[GetNewId]('Institution.StudentTranscriptExamDetail')),
	[StudentTranscriptID] [int] NOT NULL,
	[Exam1ID] [int] NULL,
	[Exam2ID] [int] NULL,
	[Exam3ID] [int] NULL,
	[Exam1Weight] [decimal](18, 0) NULL,
	[Exam2Weight] [decimal](18, 0) NULL,
	[Exam3Weight] [decimal](18, 0) NULL,
	[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF_StudentTranscriptExamDetail_ModifiedDate]  DEFAULT (sysdatetime()),
	[rowguid] [uniqueidentifier] NOT NULL CONSTRAINT [DF_StudentTranscriptExamDetail_rowguid]  DEFAULT (newid()),
 CONSTRAINT [PK_StudentTranscriptExamDetail] PRIMARY KEY CLUSTERED 
(
	[StudentTranscriptExamDetailID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
END
GO
...
SET ANSI_PADDING ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Institution].[StudentTranscriptDetail]') AND type in (N'U'))
BEGIN
CREATE TABLE [Institution].[StudentTranscriptDetail](
	[StudentTranscriptDetailID] [int] NOT NULL CONSTRAINT [DF_StudentTranscriptDetail_StudentTranscriptDetailID]  DEFAULT ([dbo].[GetNewID]('Institution.StudentTranscriptDetail')),
	[StudentTranscriptID] [int] NOT NULL,
	[SubjectID] [int] NOT NULL,
	[Remarks] [varchar](50) NULL,
	[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF_StudentTranscriptDetail_ModifiedDate]  DEFAULT (sysdatetime()),
	[rowguid] [uniqueidentifier] NOT NULL CONSTRAINT [DF_StudentTranscriptDetail_rowguid]  DEFAULT (newid()),
 CONSTRAINT [PK_StudentTranscriptDetail] PRIMARY KEY CLUSTERED 
(
	[StudentTranscriptDetailID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[BookReceiptDetail]') AND type in (N'U'))
BEGIN
CREATE TABLE [Sales].[BookReceiptDetail](
	[BookReceiptDetailID] [int] NOT NULL CONSTRAINT [DF_BookReceiptDetail_BookReceiptDetailID_1]  DEFAULT ([dbo].[Link_GetNewID]('Sales.BookReceiptDetail')),
	[BookReceiptID] [int] NOT NULL,
	[BookID] [int] NOT NULL,
	[Quantity] [decimal](18, 0) NOT NULL,
	[UnitCost] [decimal](18, 0) NOT NULL,
	[LineTotal] [decimal](18, 0) NOT NULL,
	[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF_BookReceiptDetail_ModifiedDate_1]  DEFAULT (sysdatetime()),
	[rowguid] [uniqueidentifier] NOT NULL CONSTRAINT [DF_BookReceiptDetail_rowguid_1]  DEFAULT (newid()),
 CONSTRAINT [PK_BookReceiptDetail_1] PRIMARY KEY CLUSTERED 
(
	[BookReceiptDetailID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
END
GO
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[Institution].[TR_StudentTranscriptExamDetail_UpdateID]'))
EXEC dbo.sp_executesql @statement = N'CREATE TRIGGER [Institution].[TR_StudentTranscriptExamDetail_UpdateID]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[Institution].[TR_StudentTranscriptDetail_UpdateID]'))
EXEC dbo.sp_executesql @statement = N'CREATE TRIGGER [Institution].[TR_StudentTranscriptDetail_UpdateID]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[Sales].[TR_BookReceiptDetail_UpdateID]'))
EXEC dbo.sp_executesql @statement = N'CREATE TRIGGER [Sales].[TR_BookReceiptDetail_UpdateID]
...
execute dbo.sp_executesql @statement = N'CREATE FUNCTION [dbo].[GetUnreturnedCopies](@bookID int)
    ...
    DECLARE @unreturnedCopies decimal;
	DECLARE @letCopies decimal;
	DECLARE @returnedCopies decimal;
 IF NOT EXISTS (SELECT * FROM [Institution].[BookIssueDetail] WHERE BookID=@bookID)
 RETURN 0
 ELSE
 BEGIN 
    set @letCopies = ISNULL((SELECT COUNT(*) FROM [Institution].[BookIssueDetail] where BookID = @bookID),0)
 set @returnedCopies = ISNULL((SELECT COUNT(*) FROM [Institution].[BookReturnDetail] where BookID = @bookID),0)
 set @unreturnedCopies = @letCopies-@returnedCopies;

    END
 RETURN @unreturnedCopies
    END
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetBookPurchaseTotal]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
execute dbo.sp_executesql @statement = N'CREATE FUNCTION [dbo].[GetBookPurchaseTotal](@bookPurchaseID int)
    RETURNS decimal
    AS
    BEGIN
 DECLARE @total decimal;
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetB7WeightedExamTotalScore]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
BEGIN
execute dbo.sp_executesql @statement = N'CREATE FUNCTION [dbo].[GetB7WeightedExamTotalScore](@studentID int, @examID int,@weight decimal)
    RETURNS decimal
    AS
    BEGIN
 DECLARE @total decimal;
 ...
 RETURN NULL
 ELSE
    set @total = (SELECT compul.Total+opt.Total FROM (SELECT SUM(ISNULL(erd.Score,0)) [Total],erh.StudentID  FROM
     [Institution].[ExamResultHeader] erh
 LEFT OUTER JOIN [Institution].[ExamResultDetail] erd ON(erh.ExamResultID= erd.ExamResultID) 
  LEFT OUTER JOIN [Institution].[Subject] sub 
 ON (sub.SubjectID = erd.SubjectID) 
 WHERE erh.StudentID=@studentID AND erh.ExamID=@examID AND erh.IsActive=1 
 AND sub.Code IN (101,102,121,231,232,233,313)
 GROUP BY erh.StudentID) compul 
 LEFT OUTER JOIN 
 (SELECT MAX(erd.Score) Total,erh.StudentID FROM [Institution].[ExamResultHeader] erh 
 LEFT OUTER JOIN [Institution].[ExamResultDetail] erd 
 ON(erh.ExamResultID= erd.ExamResultID) LEFT OUTER JOIN [Institution].[Subject] sub 
 ON (sub.SubjectID = erd.SubjectID) WHERE erh.StudentID=@studentID AND 
 erh.ExamID=@examID AND erh.IsActive=1 AND sub.Code IN (311,312,443,565)
 GROUP BY erh.StudentID) opt ON (opt.StudentID=compul.StudentID)) 
...
SET ANSI_PADDING ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[Sales].[BookReceiptHeader]') AND type in (N'U'))
BEGIN
CREATE TABLE [Sales].[BookReceiptHeader](
	...
	[IsCancelled] [bit] NOT NULL CONSTRAINT [DF_BookReceiptHeader_IsCancelled]  DEFAULT ((0)),
	[DateReceived] [datetime] NOT NULL,
	[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF_BookReceiptHeader_ModifiedDate]  DEFAULT (sysdatetime()),
	[rowguid] [uniqueidentifier] NOT NULL CONSTRAINT [DF_BookReceiptHeader_rowguid]  DEFAULT (newid()),
 CONSTRAINT [PK_BookReceiptHeader] PRIMARY KEY CLUSTERED 
(
	[BookReceiptID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[Sales].[TR_BookReceiptHeader_UpdateID]'))
EXEC dbo.sp_executesql @statement = N'CREATE TRIGGER [Sales].[TR_BookReceiptHeader_UpdateID]
...
GO
GRANT ALTER TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY ASYMMETRIC KEY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY APPLICATION ROLE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY ASSEMBLY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY CERTIFICATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY DATABASE AUDIT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY DATASPACE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY DATABASE EVENT NOTIFICATION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY FULLTEXT CATALOG TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY MESSAGE TYPE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY ROLE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY ROUTE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY REMOTE SERVICE BINDING TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY CONTRACT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY SYMMETRIC KEY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY SCHEMA TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY SERVICE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY DATABASE DDL TRIGGER TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT ALTER ANY USER TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT AUTHENTICATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT BACKUP DATABASE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT BACKUP LOG TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CONTROL TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CONNECT REPLICATION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CHECKPOINT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE AGGREGATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE ASYMMETRIC KEY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE ASSEMBLY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE CERTIFICATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE DEFAULT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE DATABASE DDL EVENT NOTIFICATION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE FUNCTION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE FULLTEXT CATALOG TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE MESSAGE TYPE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE PROCEDURE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE QUEUE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE ROLE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE ROUTE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE RULE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE REMOTE SERVICE BINDING TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE CONTRACT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE SYMMETRIC KEY TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE SCHEMA TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE SYNONYM TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE SERVICE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE TABLE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE TYPE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE VIEW TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT CREATE XML SCHEMA COLLECTION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT DELETE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT EXECUTE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT INSERT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT REFERENCES TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT SELECT TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT SHOWPLAN TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT SUBSCRIBE QUERY NOTIFICATIONS TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT TAKE OWNERSHIP TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT UPDATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT VIEW DEFINITION TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
GRANT VIEW DATABASE STATE TO [SystemAdmin] WITH GRANT OPTION  AS [dbo]
GO
USE [UmanyiSMS]
GO
...
GO
GRANT EXECUTE ON [dbo].[GetTablePrimaryKeyColumn] TO [Deputy] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[GetTablePrimaryKeyColumn] TO [Principal] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[GetTablePrimaryKeyColumn] TO [Teacher] AS [dbo]
GO
...
GO
GRANT SELECT ON [Institution].[ExamResultHeader] TO [Accounts] AS [dbo]
GO
...
GO
GRANT DELETE ON [Institution].[StudentTranscriptDetail] TO [Deputy] AS [dbo]
GO
GRANT INSERT ON [Institution].[StudentTranscriptDetail] TO [Deputy] AS [dbo]
GO
GRANT SELECT ON [Institution].[StudentTranscriptDetail] TO [Deputy] AS [dbo]
GO
GRANT UPDATE ON [Institution].[StudentTranscriptDetail] TO [Deputy] AS [dbo]
GO
GRANT DELETE ON [Institution].[StudentTranscriptDetail] TO [Principal] AS [dbo]
GO
GRANT INSERT ON [Institution].[StudentTranscriptDetail] TO [Principal] AS [dbo]
GO
GRANT SELECT ON [Institution].[StudentTranscriptDetail] TO [Principal] AS [dbo]
GO
GRANT UPDATE ON [Institution].[StudentTranscriptDetail] TO [Principal] AS [dbo]
GO
GRANT DELETE ON [Institution].[StudentTranscriptDetail] TO [Teacher] AS [dbo]
GO
GRANT INSERT ON [Institution].[StudentTranscriptDetail] TO [Teacher] AS [dbo]
GO
...
GO
GRANT SELECT ON [Sales].[BookReceiptDetail] TO [Accounts] AS [dbo]
GO
GRANT DELETE ON [Sales].[BookReceiptDetail] TO [Deputy] AS [dbo]
GO
GRANT INSERT ON [Sales].[BookReceiptDetail] TO [Deputy] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptDetail] TO [Deputy] AS [dbo]
GO
GRANT UPDATE ON [Sales].[BookReceiptDetail] TO [Deputy] AS [dbo]
GO
GRANT DELETE ON [Sales].[BookReceiptDetail] TO [Principal] AS [dbo]
GO
GRANT INSERT ON [Sales].[BookReceiptDetail] TO [Principal] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptDetail] TO [Principal] AS [dbo]
GO
GRANT UPDATE ON [Sales].[BookReceiptDetail] TO [Principal] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptDetail] TO [Teacher] AS [dbo]
GO
...
GO
GRANT SELECT ON [Institution].[ExamDetail] TO [Accounts] AS [dbo]
GO
...
GO
GRANT SELECT ON [Institution].[ExamClassDetail] TO [Accounts] AS [dbo]
GO
...
GO
GRANT DELETE ON [Sales].[BookReceiptHeader] TO [Deputy] AS [dbo]
GO
GRANT INSERT ON [Sales].[BookReceiptHeader] TO [Deputy] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptHeader] TO [Deputy] AS [dbo]
GO
GRANT UPDATE ON [Sales].[BookReceiptHeader] TO [Deputy] AS [dbo]
GO
GRANT DELETE ON [Sales].[BookReceiptHeader] TO [Principal] AS [dbo]
GO
GRANT INSERT ON [Sales].[BookReceiptHeader] TO [Principal] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptHeader] TO [Principal] AS [dbo]
GO
GRANT UPDATE ON [Sales].[BookReceiptHeader] TO [Principal] AS [dbo]
GO
GRANT SELECT ON [Sales].[BookReceiptHeader] TO [Teacher] AS [dbo]
GO
